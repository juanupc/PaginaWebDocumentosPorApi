...
using SubirDocumentos.Models;
using System.Diagnostics;

using System.Net.Http.Headers;

namespace SubirDocumentos.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> SubirArchivo(string descripcion, IFormFile documento)
        {
            ...
            using (var multipartFormContent = new MultipartFormDataContent())
            {
                ...
                var response = await cliente.PostAsync("http://localhost:5023/api/Documento/Subir", multipartFormContent);
